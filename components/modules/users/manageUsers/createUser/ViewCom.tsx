...
// Main Function
const ViewCom = ({setIsViewOpened, users, setUpdateUser, setSelectedSchools, setFile, setImgSrc}:any) => {
                    ...
                    <CommandList>
                        {
                            users.length < 1 ? (
                                <p className='w-full flex flex-row p-2 text-sm bg-[#E2E4FF] border-b-[0.5px] border-[#ccc]'>
                                    ...
                                    >
                                        <li className='basis-[20%] flex flex-row items-center px-2 border-r-[0.5px] border-[#ccc]'>{users.indexOf(c) + 1}</li>
                                        ...
                                        <li className='basis-[15%] flex flex-row items-center px-2 border-r-[0.5px] border-[#ccc]'>{c.email}</li>
