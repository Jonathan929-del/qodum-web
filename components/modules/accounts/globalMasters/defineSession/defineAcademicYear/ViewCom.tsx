        ...
        >
            ...
            <div className='w-[95%] h-[90%] flex flex-col items-center bg-[#F1F1F1] rounded-[8px]'>
                ...
                <div className='w-full flex flex-col h-[90%] overflow-scroll custom-sidebar-scrollbar'>
                    {/* Headings */}
                    <ul className='w-full flex flex-row min-w-[700px] text-[10px] border-b-[0.5px] border-[#ccc] text-hash-color cursor-pointer sm:text-xs md:text-md'>
                    ...
                    <CommandList>
                        {
                            !academicYears[0]?.year_name ? (
                                ...
                                >
                                    <li className='basis-[7.5%] flex flex-row items-center px-2 border-r-[0.5px] border-[#ccc] sm:basis-[10%]'>{academicYears.indexOf(year) + 1}</li>
