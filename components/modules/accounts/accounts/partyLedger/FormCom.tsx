            ...
            >
                ...
                >
                    ...
                    <div className='sm:px-10'>
                        <Buttons setIsViewOpened={setIsViewOpened} partyLedgers={partyLedgers} updatePartyLedger={updatePartyLedger} setUpdatePartyLedger={setUpdatePartyLedger} onSubmit={onSubmit} form={form}/>
                    </div>
                </form>
            </Form>
        </div>
