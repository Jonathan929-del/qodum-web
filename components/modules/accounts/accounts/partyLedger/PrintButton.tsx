...
// Main Function
const PrintButton = ({partyLedgers}:any) => {


    // Account Groups Array
    const excelpartyLedgersArray = partyLedgers.map((ledger:any) => {
        return([
            {value:partyLedgers.indexOf(ledger) + 1},
    ...
    const excelData:any = [
        {
            columns:[
                ...
                {title:'', style:{fill:{patternType:'solid', fgColor:{rgb:'16365C'}}}},
                {title:'', style:{fill:{patternType:'solid', fgColor:{rgb:'16365C'}}}},
                {title:'Party Ledgers', width:{wpx:500}, style:{font:{bold:true, sz:'12', color:{rgb:'ffffff'}}, fill:{patternType:'solid', fgColor:{rgb:'16365C'}}}},
                {title:'', style:{fill:{patternType:'solid', fgColor:{rgb:'16365C'}}}},
                {title:'', style:{fill:{patternType:'solid', fgColor:{rgb:'16365C'}}}},
                {title:'', style:{fill:{patternType:'solid', fgColor:{rgb:'16365C'}}}},
                {title:'', style:{fill:{patternType:'solid', fgColor:{rgb:'16365C'}}}},
