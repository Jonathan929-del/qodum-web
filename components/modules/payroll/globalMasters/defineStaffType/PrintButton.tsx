...
// Main Function
const PrintButton = ({staffTypes}:any) => {


    // Staff types array
    const staffTypesArray = staffTypes.map((r:any) => {
        return([
            {value:r.staff_type},
            {value:r.is_hourly_paid ? 'True' : 'False'},
            {value:r.show_on_ecare ? 'True' : 'False'},
    ...
    const data:any = [
        {
            columns:[
                {title:'Staff Types List', width:{wpx:400}, style:{font:{bold:true, sz:'11', color:{rgb:'ffffff'}}, fill:{patternType:'solid', fgColor:{rgb:'16365C'}}}},
        ...
        {
            columns: [
                {title:'Staff Type', width:{wpx:100}, style:{font:{bold:true}, fill:{patternType:'solid', fgColor:{rgb:'C9CACC'}}}},
                {title:'Is Hourly Paid', width:{wpx:100}, style:{font:{bold:true}, fill:{patternType:'solid', fgColor:{rgb:'C9CACC'}}}},
                {title:'Show On Ecare', width:{wpx:100}, style:{font:{bold:true}, fill:{patternType:'solid', fgColor:{rgb:'C9CACC'}}}},
                {title:'Created At', width:{wpx:75}, style:{font:{bold:true}, fill:{patternType:'solid', fgColor:{rgb:'C9CACC'}}}}
            ],
            data:staffTypesArray,
        }
    ];
