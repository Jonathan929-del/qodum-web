...
// Main Function
const ViewCom = ({setIsViewOpened, professions, setUpdateProfession}:any) => {
                    ...
                    <CommandList>
                        {
                            professions.length < 1 ? (
                                <p className='w-full flex flex-row p-2 text-sm bg-[#E2E4FF] border-b-[0.5px] border-[#ccc]'>
                                    ...
                                    <LoadingIcon />
                                ) : professions.map((c:any) => (
                                    <CommandItem
                                        value={`${professions.indexOf(c) + 1} ${c.profession}`}
                                        className='w-full min-w-[300px] flex flex-row text-[10px] bg-[#E2E4FF] border-b-[0.5px] border-[#ccc] sm:text-xs md:text-md'
                                    >
                                        <li className='basis-[20%] flex flex-row items-center px-2 border-r-[0.5px] border-[#ccc]'>{professions.indexOf(c) + 1}</li>
                                        ...
                                        <li className='basis-[60%] flex flex-row items-center px-2'>{c.profession}</li>
                                    </CommandItem>
                                ))
                        }
                    </CommandList>
