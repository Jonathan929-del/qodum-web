...
// Main Function
const PrintButton = ({professions}:any) => {


    // professions array
    const professionsArray = professions.map((r:any) => {
        return([
            {value:r.profession},
    ...
    const data:any = [
        {
            columns:[
                {title:'Professions List', width:{wpx:400}, style:{font:{bold:true, sz:'11', color:{rgb:'ffffff'}}, fill:{patternType:'solid', fgColor:{rgb:'16365C'}}}},
        ...
        {
            columns: [
                {title:'Profession', width:{wpx:100}, style:{font:{bold:true}, fill:{patternType:'solid', fgColor:{rgb:'C9CACC'}}}},
