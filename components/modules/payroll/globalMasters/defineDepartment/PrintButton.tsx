...
// Main Function
const PrintButton = ({departments}:any) => {


    // Departments array
    const departmentsArray = departments.map((r:any) => {
        return([
            {value:r.department},
    ...
    const data:any = [
        {
            columns:[
                {title:'Departments List', width:{wpx:400}, style:{font:{bold:true, sz:'11', color:{rgb:'ffffff'}}, fill:{patternType:'solid', fgColor:{rgb:'16365C'}}}},
        ...
        {
            columns: [
                {title:'Department', width:{wpx:100}, style:{font:{bold:true}, fill:{patternType:'solid', fgColor:{rgb:'C9CACC'}}}},
