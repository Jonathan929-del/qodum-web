...
// Main Function
const PrintButton = ({designations}:any) => {


    // Designations array
    const designationsArray = designations.map((r:any) => {
        return([
            {value:r.designation},
            {value:r.show_in_payroll ? 'True' : 'False'},
    ...
    const data:any = [
        {
            columns:[
                {title:'Designations List', width:{wpx:400}, style:{font:{bold:true, sz:'11', color:{rgb:'ffffff'}}, fill:{patternType:'solid', fgColor:{rgb:'16365C'}}}},
        ...
        {
            columns: [
                {title:'Designation', width:{wpx:100}, style:{font:{bold:true}, fill:{patternType:'solid', fgColor:{rgb:'C9CACC'}}}},
                {title:'Show In Payroll', width:{wpx:100}, style:{font:{bold:true}, fill:{patternType:'solid', fgColor:{rgb:'C9CACC'}}}},
