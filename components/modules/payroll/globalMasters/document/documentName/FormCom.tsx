...
import { createStaffDocument, deleteStaffDocument, modifyStaffDocument } from '@/lib/actions/payroll/globalMasters/document/staffDocument.actions';
...
const FormCom = ({documentTypes, setIsViewOpened, documents, updateDocument, setUpdateDocument}:any) => {
    ...
    const onSubmit = async (values:z.infer<typeof DocumentValidation>) => {
        ...
        if(updateDocument.id === ''){
            ...
            const res = await createStaffDocument({
        ...
        // Delete document
            ...
            await deleteStaffDocument({id:updateDocument.id});
