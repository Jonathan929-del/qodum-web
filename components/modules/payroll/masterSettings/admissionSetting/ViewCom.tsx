                    ...
                    <CommandList>
                        {
                            admissions.length < 1 ? (
                                <p className='w-full min-w-[800px] flex flex-row p-2 text-sm bg-[#E2E4FF] border-b-[0.5px] border-[#ccc]'>
                                    ...
                                    >
                                        <li className='basis-[10%] flex flex-row items-center px-2 border-r-[0.5px] border-[#ccc]'>{admissions.indexOf(item) + 1}</li>
                                        ...
                                        <li className='basis-[15%] flex flex-row items-center px-2 border-r-[0.5px] border-[#ccc]'>{item.should_be}</li>
                                        <li className='basis-[15%] flex flex-row items-center px-2 border-r-[0.5px] border-[#ccc]'>{item.start_from}</li>
                                        <li className='basis-[15%] flex flex-row items-center px-2 border-r-[0.5px] border-[#ccc]'>{item.prefix}</li>
                                        <li className='basis-[15%] flex flex-row items-center px-2 border-r-[0.5px] border-[#ccc]'>{item.suffix}</li>
                                        <li className='basis-[15%] flex flex-row items-center px-2'>{item.setting_type}</li>
                                    </CommandItem>
                                ))
                        }
                    </CommandList>
