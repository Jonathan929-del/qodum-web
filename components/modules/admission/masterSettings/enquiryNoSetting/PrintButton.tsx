...
// Main Function
const PrintButton = ({enquiryNoSettings}:any) => {


    // Blood groups array
    const enquiryNoSettingsArray = enquiryNoSettings.map((r:any) => {
        return([
            {value:r.blood_group},
    ...
    const data:any = [
        {
            columns:[
                {title:'Blood Groups List', width:{wpx:400}, style:{font:{bold:true, sz:'11', color:{rgb:'ffffff'}}, fill:{patternType:'solid', fgColor:{rgb:'16365C'}}}},
        ...
        {
            columns: [
                {title:'Blood Group', width:{wpx:100}, style:{font:{bold:true}, fill:{patternType:'solid', fgColor:{rgb:'C9CACC'}}}},
                {title:'Created At', width:{wpx:75}, style:{font:{bold:true}, fill:{patternType:'solid', fgColor:{rgb:'C9CACC'}}}}
            ],
            data:enquiryNoSettingsArray,
        }
    ];
