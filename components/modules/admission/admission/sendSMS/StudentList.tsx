...
const StudentsList = ({ form }: any) => {
    ...
    const [students, setStudents] = useState([
        { admin_no: '1375', bill_no: '120120', name: 'mohammed', new_old: 'old new', father_name: 'father one', mother_name: 'mother name', contact: 'contact', class_section: 'class sec', special_group: 'ass class', route: 'new class', stop: 'ass section', vehicle: 'new section' },
        { admin_no: '1375', bill_no: '120120', name: 'mohammed', new_old: 'old new', father_name: 'father one', mother_name: 'mother name', contact: 'contact', class_section: 'class sec', special_group: 'ass class', route: 'new class', stop: 'ass section', vehicle: 'new section' },
        { admin_no: '1375', bill_no: '120120', name: 'mohammed', new_old: 'old new', father_name: 'father one', mother_name: 'mother name', contact: 'contact', class_section: 'class sec', special_group: 'ass class', route: 'new class', stop: 'ass section', vehicle: 'new section' },
    ...
    return (
        ...
        <Command
            className='w-[100%] max-h-[90%] flex flex-col overflow-visible items-center pb-2 gap-2 rounded-[8px] border-[0.5px] border-[#E8E8E8] lg:w-[100%]'
        >
            ...
            <div className='w-full h-[90%] flex flex-col items-center bg-[#F1F1F1]'>
                ...
                <div className='w-full flex flex-col overflow-scroll custom-sidebar-scrollbar'>
                    ...
                    <ul className='w-full min-w-[1000px] flex flex-row text-[10px] border-b-2 border-[#ccc] text-hash-color cursor-pointer sm:text-xs md:text-md'>
                        ...
                        <li className=' basis-[20%] flex flex-row items-center justify-between px-2 py-[2px]'>
                            Group
                            <ChevronsUpDown size={12} />
                        </li>
