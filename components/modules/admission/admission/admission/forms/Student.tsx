...
const Student = ({students, form, setIsViewOpened, setUpdateStudent, setFile, updateStudent, imageSrc, setImageSrc, setIsLoading, setValuesFromRegister, registeredStudents, selectedSubjects, setSelectedSubjects, setSelectedDocuments, valuesFromRegister, dob, setDob, doa, setDoa, doj, setDoj}:any) => {
    ...
    return (
        <div className='flex flex-col'>
            ...
            <div className='flex flex-row mt-4'>
                <div className='basis-[30%] flex flex-col gap-2 border-r-[0.5px] border-t-[0.5px] border-[#ccc] rounded-[5px] pr-[4px] bg-[#3D67B0]'>
                ...
                <div className='basis-[70%] flex-1 flex flex-col pr-2 gap-2'>
                    <div className='flex flex-col gap-2 border-[0.5px] border-[#ccc] rounded-[5px] p-2 pt-4 ml-2 bg-[#3D67B0]'>
                        <div className='flex-1 flex flex-col gap-4 lg:gap-2 lg:flex-row'>
                            {/* DOB */}
                            <FormField
                                control={form?.control}
                    ...
                    <div className='flex flex-col gap-2 border-[0.5px] border-[#ccc] rounded-[5px] p-2 ml-2 bg-[#3D67B0]'>
                        <div className='flex flex-col gap-2 lg:flex-row'>
                            {/* H. No. and Streets */}
                            <FormField
                                control={form?.control}
                    ...
                    <div className='flex flex-col gap-2 border-[0.5px] border-[#ccc] rounded-[5px] p-2 ml-2 lg:flex-row bg-[#3D67B0]'>
                        {/* Blood Group */}
                        <div className='w-full flex flex-col items-center'>
                            <FormLabel className='w-full h-2 text-[11px] text-start pr-[4px] text-white lg:basis-[35%]'>Blood Group</FormLabel>
                            {bloodGroupsState.isLoading ? (
                    ...
                    <div className='flex flex-col gap-4 border-[0.5px] border-[#ccc] rounded-[5px] p-2 ml-2 lg:flex-row bg-[#3D67B0]'>
                        {/* Stream */}
                        <div className='w-full flex flex-col items-center'>
                            <FormLabel className='w-full h-2 text-[11px] text-start pr-[4px] text-white lg:basis-[35%]'>Stream</FormLabel>
                            {streamsState.isLoading ? (
                    ...
                    <div className='flex flex-col gap-4 border-[0.5px] border-[#ccc] rounded-[5px] p-2 ml-2 xl:flex-row bg-[#3D67B0]'>
                        <div className='flex-1 flex flex-row justify-between'>
                            {/* Is Minority */}
                            <FormField
                                control={form?.control}
