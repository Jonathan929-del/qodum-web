...
// Main Function
const PrintButton = ({meritCriterias}:any) => {


    // Merit criterias Array
    const meritCriteriasArray = meritCriterias.map((c:any) => {
        return([
            {value:c.name},
            {value:c.maximum_point}
        ]);
    });
    ...
    const data:any = [
        {
            columns:[
                {title:'Merit Criteria List', width:{wpx:275}, style:{font:{bold:true, sz:'14', color:{rgb:'ffffff'}}, fill:{patternType:'solid', fgColor:{rgb:'16365C'}}}},
        ...
        {
            columns: [
                {title:'Criteria Name', width:{wpx:125}, style:{font:{bold:true}, fill:{patternType:'solid', fgColor:{rgb:'C9CACC'}}}},
                {title:'Qualify Point', width:{wpx:75}, style:{font:{bold:true}, fill:{patternType:'solid', fgColor:{rgb:'C9CACC'}}}}
            ],
            data:meritCriteriasArray,
        }
    ];
