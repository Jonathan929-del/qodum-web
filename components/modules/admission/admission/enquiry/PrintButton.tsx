...
// Main Function
const PrintButton = ({enquiries}:any) => {


    // Enquiries Array
    const enquiriesArray = enquiries.map((student:any) => {
        return([
            {value:enquiries.indexOf(student) + 1},
    ...
    const excelData:any = [
        {
            columns:[
                {title:'enquiries', width:{wpx:500}, style:{font:{bold:true, sz:'16', color:{rgb:'ffffff'}}, fill:{patternType:'solid', fgColor:{rgb:'16365C'}}}},
