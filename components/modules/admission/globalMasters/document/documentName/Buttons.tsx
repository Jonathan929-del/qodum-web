...
// Main Function
const Buttons = ({setIsViewOpened, documents, updateDocument, setUpdateDocument, onSubmit, form}:any) => {
    ...
    return (
        <div className='flex flex-row items-center justify-center pb-4 mt-10 gap-2 ml-0'>
            {
                updateDocument.id === '' ? permissions.add && (
                    <Button
                        type='submit'
                        ...
                        {permissions.delete && (
                            <AlertDialog>
                                <AlertDialogTrigger
                                    ...
                                    onClick={() => setUpdateDocument({...updateDocument, isDeleteClicked:true})}
                                >
                                    Delete
                                </AlertDialogTrigger>
                                <AlertDialogContent>
                                    ...
                                    <AlertDialogFooter>
                                        <AlertDialogCancel
                                            onClick={() => setUpdateDocument({...updateDocument, isDeleteClicked:false})}
                                        >
                                            No
                                        </AlertDialogCancel>
                                        <Button
            ...
            {permissions.read_only && (
                <span
                    onClick={() => setIsViewOpened('document')}
            ...
            {/* Print button */}
            {permissions.print && (
                <PrintButton documents={documents}/>
            )}
