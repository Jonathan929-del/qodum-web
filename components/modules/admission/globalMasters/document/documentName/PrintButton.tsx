...
// Main Function
const PrintButton = ({documents}:any) => {


    // Documents Array
    const documentsArray = documents.map((d:any) => {
        return([
    ...
    const data:any = [
        {
            columns:[
                {title:'Documents List', width:{wpx:300}, style:{font:{bold:true, sz:'16', color:{rgb:'ffffff'}}, fill:{patternType:'solid', fgColor:{rgb:'16365C'}}}},
        ...
        {
            columns: [
                {title:'Document Type', width:{wpx:125}, style:{font:{bold:true}, fill:{patternType:'solid', fgColor:{rgb:'C9CACC'}}}},
                {title:'Document Name', width:{wpx:100}, style:{font:{bold:true}, fill:{patternType:'solid', fgColor:{rgb:'C9CACC'}}}},
