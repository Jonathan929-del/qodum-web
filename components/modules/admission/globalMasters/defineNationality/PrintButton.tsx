...
// Main Function
const PrintButton = ({nationalities}:any) => {


    // Nationalities array
    const nationalitiesArray = nationalities.map((r:any) => {
        return([
            {value:r.name},
    ...
    const data:any = [
        {
            columns:[
                {title:'Nationalities List', width:{wpx:400}, style:{font:{bold:true, sz:'11', color:{rgb:'ffffff'}}, fill:{patternType:'solid', fgColor:{rgb:'16365C'}}}},
