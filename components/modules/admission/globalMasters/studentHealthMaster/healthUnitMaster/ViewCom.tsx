                            ...
                            healthUnits.length < 1 ? (
                                <p className='w-full flex flex-row p-2 text-sm bg-[#E2E4FF] border-b-2 border-[#ccc]'>
                                    ...
                                    >
                                        ...
                                        <li className='basis-[30%] flex flex-row items-center px-2 border-r-2 border-[#ccc]'>{hUnit.unit_name}</li>
                                        <li className='basis-[30%] flex flex-row items-center px-2 border-r-2 border-[#ccc]'>{hUnit.unit_type}</li>
