...
const PrintButton = ({houses}:any) => {
    ...
    const housesArray = houses.map((house:any) => {
        return([
            ...
            {value:moment(house.createdAt).format('D-MMM-yy')}
        ]);
    });
    ...
    const data:any = [
        {
            columns:[
                {title:'Houses List', width:{wpx:400}, style:{font:{bold:true, sz:'20', color:{rgb:'ffffff'}}, fill:{patternType:'solid', fgColor:{rgb:'16365C'}}}},
        ...
        {
            columns: [
                {title:'House Name', width:{wpx:150}, style:{font:{bold:true}, fill:{patternType:'solid', fgColor:{rgb:'C9CACC'}}}},
