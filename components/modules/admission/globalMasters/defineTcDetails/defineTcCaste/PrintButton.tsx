...
// Main Function
const PrintButton = ({casts}:any) => {


    // casts Array
    const castsArray = casts.map((c:any) => {
        return([
            {value:c.caste_name},
            {value:moment(c.createdAt).format('D-MMM-yy')}
        ]);
    });
    ...
    const data:any = [
        {
            columns:[
                {title:'TC Cast List', width:{wpx:275}, style:{font:{bold:true, sz:'16', color:{rgb:'ffffff'}}, fill:{patternType:'solid', fgColor:{rgb:'16365C'}}}},
        ...
        {
            columns: [
                {title:'TC Caste', width:{wpx:125}, style:{font:{bold:true}, fill:{patternType:'solid', fgColor:{rgb:'C9CACC'}}}},
