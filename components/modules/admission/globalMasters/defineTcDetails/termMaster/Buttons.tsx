...
// Main Function
const Buttons = ({setIsViewOpened, termMasters, updateTermMaster, setUpdateTermMaster, onSubmit, form}:any) => {
    ...
    return (
        <div className='flex flex-row items-center justify-center pb-4 mt-10 gap-2 ml-0'>
                    ...
                    <>
                        ...
                        <AlertDialog>
                            <AlertDialogTrigger
                                ...
                                onClick={() => setUpdateTermMaster({...updateTermMaster, isDeleteClicked:true})}
                            >
                                Delete
                            </AlertDialogTrigger>
                            <AlertDialogContent>
                                ...
                                <AlertDialogFooter>
                                    <AlertDialogCancel
                                        onClick={() => setUpdateTermMaster({...updateTermMaster, isDeleteClicked:false})}
                                    >
                                        No
                                    </AlertDialogCancel>
                                    <Button
            ...
            {/* Print button */}
            <PrintButton termMasters={termMasters}/>
