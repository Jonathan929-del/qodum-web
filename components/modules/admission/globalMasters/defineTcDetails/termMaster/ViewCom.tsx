                    ...
                    <CommandList>
                        {
                            terms.length < 1 ? (
                                <p className='w-full flex flex-row p-2 text-sm bg-[#E2E4FF] border-b-[0.5px] border-[#ccc]'>
                                    ...
                                    <CommandItem
                                        key={index}
                                        value={`${terms.indexOf(t) + 1} ${t.term_name}`}
                                        className='w-full min-w-[600px] flex flex-row text-[10px] bg-[#E2E4FF] border-b-[0.5px] border-[#ccc] sm:text-xs md:text-md'
                                    >
                                        <li className='basis-[20%] flex flex-row items-center px-2 border-r-[0.5px] border-[#ccc]'>{terms.indexOf(t) + 1}</li>
                                        ...
                                        <li className='basis-[40%] flex flex-row items-center px-2 border-r-[0.5px] border-[#ccc]'>{t.term_name}</li>
                                        <li className='basis-[40%] flex flex-row items-center px-2'>{moment(t.updateAt).format('D-MMM-yy')}</li>
                                    </CommandItem>
                                ))
                        }
                    </CommandList>
