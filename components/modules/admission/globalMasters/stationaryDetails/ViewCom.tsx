...
// Main Function
const ViewCom = ({setIsViewOpened, stationaryDetails, setUpdateStationaryDetails}:any) => {
        ...
        >
            ...
            <div className='w-[95%] h-[90%] flex flex-col items-center bg-[#F1F1F1] rounded-[8px]'>
                ...
                <div className='w-full flex flex-col h-[90%] overflow-scroll custom-sidebar-scrollbar'>
                    ...
                    <CommandList>
                        {
                            stationaryDetails.length < 1 ? (
                                <p className='w-full flex flex-row p-2 text-sm bg-[#E2E4FF] border-b-[0.5px] border-[#ccc]'>
                                    No stationary details yet
                                </p>
                            ) : !stationaryDetails[0]?.stationary_name ? (
                                    <LoadingIcon />
                    ...
                    {stationaryDetails.length > 1 && <CommandEmpty>No results found</CommandEmpty>}
                </div>
