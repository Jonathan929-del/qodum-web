...
// Main Function
const PrintButton = ({cadetTypes}:any) => {


    // cadetTypes array
    const cadetTypesArray = cadetTypes.map((r:any) => {
        return([
            {value:r.name},
    ...
    const data:any = [
        {
            columns:[
                {title:'Cadet Types List', width:{wpx:400}, style:{font:{bold:true, sz:'11', color:{rgb:'ffffff'}}, fill:{patternType:'solid', fgColor:{rgb:'16365C'}}}},
