...
// Main Function
const ViewCom = ({setIsViewOpened, bloodGroups, setUpdateBloodGroup}:any) => {
                    ...
                    <CommandList>
                        {
                            bloodGroups.length < 1 ? (
                                <p className='w-full flex flex-row p-2 text-sm bg-[#E2E4FF] border-b-[0.5px] border-[#ccc]'>
                                    ...
                                    <LoadingIcon />
                                ) : bloodGroups.map((c:any) => (
                                    <CommandItem
                                        value={`${bloodGroups.indexOf(c) + 1} ${c.blood_group}`}
                                        className='w-full min-w-[300px] flex flex-row text-[10px] bg-[#E2E4FF] border-b-[0.5px] border-[#ccc] sm:text-xs md:text-md'
                                    >
                                        <li className='basis-[20%] flex flex-row items-center px-2 border-r-[0.5px] border-[#ccc]'>{bloodGroups.indexOf(c) + 1}</li>
                                        ...
                                        <li className='basis-[60%] flex flex-row items-center px-2'>{c.blood_group}</li>
                                    </CommandItem>
                                ))
                        }
                    </CommandList>
                    {bloodGroups.length > 0 && <CommandEmpty>No results found</CommandEmpty>}
                </div>
