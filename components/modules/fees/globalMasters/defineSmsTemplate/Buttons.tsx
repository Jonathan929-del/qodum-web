...
// Main Function
const Buttons = ({setIsViewOpened, smsTemplates, updateSmsTemplate, setUpdateSmsTemplate, onSubmit, form}:any) => {
    ...
    return (
        <div className='flex flex-row items-center justify-between gap-2 ml-0'>
            {
                updateSmsTemplate.id === '' ? permissions.add && (
                    <Button
                        type='submit'
                        ...
                        {permissions.delete && (
                            <AlertDialog>
                                <AlertDialogTrigger
                                    ...
                                    onClick={() => setUpdateSmsTemplate({...updateSmsTemplate, isDeleteClicked:true})}
                                >
                                    Delete
                                </AlertDialogTrigger>
                                <AlertDialogContent>
                                    ...
                                    <AlertDialogFooter>
                                        <AlertDialogCancel
                                            onClick={() => setUpdateSmsTemplate({...updateSmsTemplate, isDeleteClicked:false})}
                                        >
                                            No
                                        </AlertDialogCancel>
                                        <AlertDialogAction>
            ...
            {/* Print button */}
            {permissions.print && (
                <PrintButton smsTemplates={smsTemplates}/>
            )}
