            ...
            <Page  style={styles.body}>
                ...
                <View style={{width:'100%', display:'flex', flexDirection:'column', alignItems:'center', fontSize:10, borderWidth:0.75, borderColor:'#ccc'}}>
                    ...
                    <View style={{display:'flex', flexDirection:'row', alignItems:'center', backgroundColor:'#435680', borderBottomWidth:0.5, borderBottomColor:'#ccc', color:'#fff',}}>
                        <Text style={{flexBasis:'22.5%', display:'flex', alignItems:'center', justifyContent:'center', textAlign:'center', paddingVertical:2,  borderRightWidth:0.5, borderRightColor:'#ccc'}}>HEAD NAME</Text>
                        <Text style={{flexBasis:'22.5%', display:'flex', alignItems:'center', justifyContent:'center', textAlign:'center', paddingVertical:2,  borderRightWidth:0.5, borderRightColor:'#ccc'}}>ACTUAL AMOUNT</Text>
                        <Text style={{flexBasis:'25%', display:'flex', alignItems:'center', justifyContent:'center', textAlign:'center', paddingVertical:2,  borderRightWidth:0.5, borderRightColor:'#ccc'}}>CONCESSION AMOUNT</Text>
                    ...
                    {receiptPaymentData.paid_heads.map((h:any) => (
                        <View style={{
                            ...
                            <Text style={{flexBasis:'22.5%', display:'flex', alignItems:'center', justifyContent:'center', textAlign:'center', paddingVertical:2,  borderRightWidth:0.5, borderRightColor:'#ccc'}}>{h.head_name}</Text>
                            <Text style={{flexBasis:'22.5%', display:'flex', alignItems:'center', justifyContent:'center', textAlign:'center', paddingVertical:2,  borderRightWidth:0.5, borderRightColor:'#ccc'}}>{totalNumberGenerator(h.amounts.filter((a:any) => receiptPaymentData.installments.includes(a.name)).map((a:any) => Number(a.value)))}</Text>
                            <Text style={{flexBasis:'25%', display:'flex', alignItems:'center', justifyContent:'center', textAlign:'center', paddingVertical:2,  borderRightWidth:0.5, borderRightColor:'#ccc'}}>{totalNumberGenerator(h.amounts.filter((a:any) => receiptPaymentData.installments.includes(a.name)).map((a:any) => Number(a.conc_amount)))}</Text>
                    ...
                    <View style={{
                        ...
                        <Text style={{flexBasis:'22.5%', display:'flex', alignItems:'center', justifyContent:'center', textAlign:'center', paddingVertical:2,  borderRightWidth:0.5, borderRightColor:'#ccc'}}>Total</Text>
                        <Text style={{flexBasis:'22.5%', display:'flex', alignItems:'center', justifyContent:'center', textAlign:'center', paddingVertical:2,  borderRightWidth:0.5, borderRightColor:'#ccc'}}>{totalNumberGenerator(receiptPaymentData.paid_heads.map((h:any) => totalNumberGenerator(h.amounts.filter((a:any) => receiptPaymentData.installments.includes(a.name)).map((a:any) => Number(a.value)))))}</Text>
                        <Text style={{flexBasis:'25%', display:'flex', alignItems:'center', justifyContent:'center', textAlign:'center', paddingVertical:2,  borderRightWidth:0.5, borderRightColor:'#ccc'}}>{totalNumberGenerator(receiptPaymentData.paid_heads.map((h:any) => totalNumberGenerator(h.amounts.filter((a:any) => receiptPaymentData.installments.includes(a.name)).map((a:any) => Number(a.conc_amount)))))}</Text>
