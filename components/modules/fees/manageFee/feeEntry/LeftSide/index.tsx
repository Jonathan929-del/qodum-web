...
const index = ({selectedStudent}:any) => {
    return (
        <div className='basis-[40%] w-[40%] min-w-[250px] max-w-[350px] h-full flex flex-col px-2 gap-2 text-xs bg-[#F7F7F7] rounded-[4px] border-[0.5px] border-[#ccc] font-semibold'>
