...
// Main Function
const Buttons = ({setIsViewOpened, transportMediums, updateTransportMedium, setUpdateTransportMedium, onSubmit, form}:any) => {
    ...
    // Use effect
    useEffect(() => {
        const grantedPermissions = user?.permissions?.find((p:any) => p.name === 'Fees')?.permissions?.find((pp:any) => pp.sub_menu === 'Define Transport Medium');
    ...
    return (
        <div className='flex flex-row items-center justify-between pb-4 pt-8 gap-2 ml-0'>
            {
                updateTransportMedium.id === '' ? permissions.add && (
                    <Button
                        type='submit'
                        ...
                        {permissions.delete && (
                            <AlertDialog>
                                <AlertDialogTrigger
                                    ...
                                    onClick={() => setUpdateTransportMedium({...updateTransportMedium, isDeleteClicked:true})}
                                >
                                    Delete
                                </AlertDialogTrigger>
                                <AlertDialogContent>
                                    ...
                                    <AlertDialogFooter>
                                        <AlertDialogCancel
                                            onClick={() => setUpdateTransportMedium({...updateTransportMedium, isDeleteClicked:false})}
                                        >
                                            No
                                        </AlertDialogCancel>
                                        <AlertDialogAction>
            ...
            {/* Print button */}
            {permissions.print && (
                <PrintButton transportMediums={transportMediums}/>
            )}
