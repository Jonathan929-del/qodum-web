...
// Main Function
const PrintButton = ({vehicleTypes}:any) => {


    // Vehicle types Array
    const excelVehicleTypesArray = vehicleTypes?.map((vehicleType:any) => {
        return([
            {value:vehicleType.vehicle_name},
            {value:moment(vehicleType.createdAt).format('D-MMM-yy')},
        ]);
    });
