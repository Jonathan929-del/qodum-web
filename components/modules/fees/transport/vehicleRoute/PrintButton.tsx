...
// Main Function
const PrintButton = ({vehicleRoutes}:any) => {


    // Vehicle types Array
    const excelVehicleRoutesArray = vehicleRoutes?.map((vehicleRoute:any) => {
        return([
            {value:vehicleRoute.route_no},
            {value:vehicleRoute.route_description},
            {value:vehicleRoute.route_in_charge_name},
            {value:vehicleRoute.route_in_charge_mobile_no},
        ]);
    });
    ...
    const excelData:any = [
        {
            columns:[
                ...
                {title:'Vehicle Types List', width:{wpx:500}, style:{font:{bold:true, sz:'16', color:{rgb:'ffffff'}}, fill:{patternType:'solid', fgColor:{rgb:'16365C'}}}},
                {title:'', style:{fill:{patternType:'solid', fgColor:{rgb:'16365C'}}}},
                {title:'', style:{fill:{patternType:'solid', fgColor:{rgb:'16365C'}}}}
            ],
            data:[]
        ...
        {
            columns: [
                {title:'Route No.', width:{wpx:75}, style:{font:{bold:true}, fill:{patternType:'solid', fgColor:{rgb:'C9CACC'}}}},
                {title:'Route Description', width:{wpx:200}, style:{font:{bold:true}, fill:{patternType:'solid', fgColor:{rgb:'C9CACC'}}}},
                {title:'Route Incharge Name', width:{wpx:150}, style:{font:{bold:true}, fill:{patternType:'solid', fgColor:{rgb:'C9CACC'}}}},
                {title:'Route Incharge Mobile', width:{wpx:150}, style:{font:{bold:true}, fill:{patternType:'solid', fgColor:{rgb:'C9CACC'}}}},
            ],
            data:excelVehicleRoutesArray
        }
    ];
