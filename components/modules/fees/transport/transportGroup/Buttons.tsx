...
const Buttons = ({setIsViewOpened, transportGroups, updateTransportGroup, setUpdateTransportGroup, onSubmit, form}:any) => {
    ...
    return (
        <div className='flex flex-row items-center justify-between pb-4 pt-8 gap-2 ml-0'>
            {
                updateTransportGroup.id === '' ? permissions.add && (
                    <Button
                        type='submit'
                        ...
                        {permissions.delete && (
                            <AlertDialog>
                                <AlertDialogTrigger
                                    ...
                                    onClick={() => setUpdateTransportGroup({...updateTransportGroup, isDeleteClicked:true})}
                                >
                                    Delete
                                </AlertDialogTrigger>
                                <AlertDialogContent>
                                    ...
                                    <AlertDialogFooter>
                                        <AlertDialogCancel
                                            onClick={() => setUpdateTransportGroup({...updateTransportGroup, isDeleteClicked:false})}
                                        >
                                            No
                                        </AlertDialogCancel>
                                        <AlertDialogAction>
            ...
            {/* Print button */}
            {permissions.print && (
                <PrintButton transportGroups={transportGroups}/>
            )}
