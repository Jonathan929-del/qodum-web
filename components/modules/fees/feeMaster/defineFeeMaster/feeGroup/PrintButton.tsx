...
// Main Function
const PrintButton = ({groups}:any) => {

    

    // Groups Array
    const groupsArray = groups.map((group:any) => {
        return([
            {value:group.name},
            {value:group.is_special},
            {value:moment(group.createdAt).format('D-MMM-yy')}
        ]);
    });
    ...
    const data:any = [
        {
            columns:[
                {title:'Groups List', width:{wpx:400}, style:{font:{bold:true, sz:'20', color:{rgb:'ffffff'}}, fill:{patternType:'solid', fgColor:{rgb:'16365C'}}}},
        ...
        },
        {
            columns: [
                ...
                {title:'Is_Special ', width:{wpx:150}, style:{font:{bold:true}, fill:{patternType:'solid', fgColor:{rgb:'C9CACC'}}}},
