                    ...
                    <CommandList>
                        {
                            types.length < 1 ? (
                                ...
                                >
                                    <li className='basis-[15%] flex flex-row items-center px-2 border-r-[0.5px] border-[#ccc]'>{types.indexOf(type) + 1}</li>
                                    ...
                                    <li className='basis-[20%] flex flex-row items-center px-2 border-r-[0.5px] border-[#ccc]'>{type.name}</li>
                                    <li className='basis-[20%] flex flex-row items-center px-2 border-r-[0.5px] border-[#ccc]'>{type.preference_no}</li>
                                    <li className='basis-[25%] flex flex-row items-center px-2'>{moment(type.updateAt).format('D-MMM-yy')}</li>
                                </CommandItem>
                            ))
                        }
                    </CommandList>
                    {types.length > 1 && <CommandEmpty>No results found</CommandEmpty>}
                </div>
