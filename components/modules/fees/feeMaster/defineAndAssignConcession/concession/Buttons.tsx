...
// Main Function
const Buttons = ({setIsViewOpened, concessions, updateConcession, setUpdateConcession, onSubmit, form}:any) => {
    ...
    return (
        <div className='flex flex-row items-center justify-center pb-4 mt-10 gap-2 ml-0'>
                    ...
                    <>
                        ...
                        <AlertDialog>
                            <AlertDialogTrigger
                                ...
                                onClick={() => setUpdateConcession({...updateConcession, isDeleteClicked:true})}
                            >
                                Delete
                            </AlertDialogTrigger>
                            <AlertDialogContent>
                                ...
                                <AlertDialogFooter>
                                    <AlertDialogCancel
                                        onClick={() => setUpdateConcession({...updateConcession, isDeleteClicked:false})}
                                    >
                                        No
                                    </AlertDialogCancel>
                                    <Button
            ...
            {/* Print button */}
            <PrintButton concessions={concessions}/>
