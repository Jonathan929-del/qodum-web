...
// Main Function
const PrintButton = ({concessions}:any) => {


    // concessions Array
    const concessionsArray = concessions?.map((concession:any) => {
        return([
            {value:concession.name},
            {value:moment(concession.updateAt).format('D-MMM-yy')}
        ]);
    });
    ...
    const data:any = [
        {
            columns:[
                {title:'Concessions List', width:{wpx:300}, style:{font:{bold:true, sz:'20', color:{rgb:'ffffff'}}, fill:{patternType:'solid', fgColor:{rgb:'16365C'}}}},
        ...
        {
            columns: [
                {title:'Concession Name', width:{wpx:200}, style:{font:{bold:true}, fill:{patternType:'solid', fgColor:{rgb:'C9CACC'}}}},
                {title:'Created At', width:{wpx:100}, style:{font:{bold:true}, fill:{patternType:'solid', fgColor:{rgb:'C9CACC'}}}}
            ],
            data:concessionsArray,
        }
    ];
