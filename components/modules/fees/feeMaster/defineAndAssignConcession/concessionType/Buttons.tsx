...
// Main Function
const Buttons = ({setIsViewOpened, concessionsTypes, updateConcessionType, setUpdateConcessionType, onSubmit, form}:any) => {
    ...
    return (
        <div className='flex flex-row items-center justify-center pb-4 mt-10 gap-2 ml-0'>
                    ...
                    <>
                        ...
                        <AlertDialog>
                            <AlertDialogTrigger
                                ...
                                onClick={() => setUpdateConcessionType({...updateConcessionType, isDeleteClicked:true})}
                            >
                                Delete
                            </AlertDialogTrigger>
                            <AlertDialogContent>
                                ...
                                <AlertDialogFooter>
                                    <AlertDialogCancel
                                        onClick={() => setUpdateConcessionType({...updateConcessionType, isDeleteClicked:false})}
                                    >
                                        No
                                    </AlertDialogCancel>
                                    <Button
            ...
            {/* Print button */}
            <PrintButton concessionsTypes={concessionsTypes}/>
