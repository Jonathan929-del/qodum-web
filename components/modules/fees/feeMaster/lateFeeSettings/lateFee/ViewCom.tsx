                    ...
                    <CommandList>
                        {
                            lateFees.length < 1 ? (
                                ...
                                <CommandItem
                                    key={index}
                                    value={`${lateFees.indexOf(f) + 1} ${f.fee_type} ${f.installment} ${f.amount} ${moment(f.due_date).format('D-MMM-yy')} ${f.late_fee_type}`}
                                ...
                                >
                                    ...
                                    <li className='basis-[12.5%] flex flex-row items-center px-2 border-r-[0.5px] border-[#ccc]'>{f.fee_group}</li>
                                    ...
                                    <li className='basis-[15%] flex flex-row items-center px-2 border-r-[0.5px] border-[#ccc]'>{moment(f.due_date).format('D-MMM-yy')}</li>
