...
import FormCom from '@/components/modules/payroll/globalMasters/document/documentType/FormCom';
import ViewCom from '@/components/modules/payroll/globalMasters/document/documentType/ViewCom';
import DocumentFormCom from '@/components/modules/payroll/globalMasters/document/documentName/FormCom';
import DocumentViewCom from '@/components/modules/payroll/globalMasters/document/documentName/ViewCom';
import {fetchStaffDocuments} from '@/lib/actions/payroll/globalMasters/document/staffDocument.actions';
import {fetchStaffDocumentTypes} from '@/lib/actions/payroll/globalMasters/document/staffDocumentType.actions';
...
const page = () => {
    ...
    useEffect(() => {
        const fetcher = async () => {
            const documentTypesRes = await fetchStaffDocumentTypes();
            const documentsRes = await fetchStaffDocuments();
